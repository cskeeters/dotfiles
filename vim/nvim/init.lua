...
-- parser_config.vhs = {
--   install_info = {
--     url = config_path.."/tree-sitter-vhs", -- local path or git repo
...
-- }
-- vim.treesitter.language.register('python', 'vhs')  -- the vhs filetype will use the python parser and queries.
